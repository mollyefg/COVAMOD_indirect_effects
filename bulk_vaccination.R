...
initialConditionsV = c(S0_withvaccination, 
                      ...
                      Ic0, Isc0, 
                      R0, M0,
                      Sv0, 0, 0, 0)	# ordered by S[1]...S[nAgeClasses], then E[1]...E[nAgeClasses],etc
...
percentAverted[c,2] = 100*round((deathArray[1,1] - deathArray[2,2])/deathArray[1,1],4)
percentAverted[c,3] = 100*round((deathArray[1,1] - deathArray[3,1])/deathArray[1,1],4)
percentAverted[c,4] = 100*round((deathArray[1,1] - deathArray[3,2])/deathArray[1,1],4)
